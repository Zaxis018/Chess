...
def playgame():
    ...
    board.fill((255, 255, 255))  # white first

    # Draw the black cells on the board
    for x in range(0, 8, 2):
        for y in range(0, 8, 2):
            pygame.draw.rect(board, (0, 70, 0), (x * cellSize, y * cellSize, cellSize, cellSize))
            pygame.draw.rect(board, (0,70, 0), ((x + 1) * cellSize, (y + 1) * cellSize, cellSize, cellSize))
                ...
                if selecting_piece and event.button==1:
                    ...
                    if valid.is_valid_move(chessboard, selected_square, destination_square, selected_piece):
                        ...
                        if (
                            ...
                            promoted_piece = utils.promote_pawn(screen, cellSize,width,height,selected_piece[0])
